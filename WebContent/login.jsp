			...
			<div class="contentright">
				...
				<div id="crbottom">
					...
					<form action="login" method="post">
						<input type="text" name="userBean.userName" placeholder="账号" class="input" />
						<input type="password" name="userBean.password"  placeholder="密码" class="input" />
						<input type="checkbox" id="ckbox" />
						<span>使我保持登录状态</span>
						<input type="submit" id="loginbtn"  value="登录" />
						<a id="notlogin" href="#">无法访问你的账户？</a>
					</form>
